...
if(isset($_POST['save'])){
    ...
    $query = "INSERT INTO profile (user_id, name, dob, gender, email, number) VALUES ('$user_id', '$name', '$dob', '$gender', '$email', '$number')";
    $data = mysqli_query($conn, $query);
    if($data){
        echo "<script>alert('Profile saved successfully'); </script>";
    }else{
        echo "<script>alert('Profile not saved'); </script>";
                    ...
                    <?php else: ?>
                        <li class="nav-item dropdown">
                            ...
                            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                                ...
                                <li><a href="profile.php" class="dropdown-item text-dark" style="color:#2874f0 !important; font-weight:bold;">My Profile</a></li>
                        ...
                        <div class="card shadow-sm border-0" style="border-radius: 2px; padding: 24px 32px; min-height: 500px;">
                            ...
                            <form method="POST" action="profile.php">
                                <div class="section mb-5">
                                    <h4 style="font-size: 18px; font-weight: 500; margin-bottom: 24px;">Personal Information <a href="profile_edit.php?id=<?php echo $_SESSION['id']; ?>" style="font-size: 14px; font-weight: 500; color: #2874f0; float: right; text-decoration: none;">Edit</a></h4>
                                    <div class="row">
                                        <div class="col-md-5">
                                            <input type="text" name="name" class="form-control" placeholder="First Name" value="<?php echo htmlspecialchars($name); ?>" style="border-radius: 2px; height: 40px; border-color: #e0e0e0; font-size: 14px;" required>
                                        </div>
                                        <div class="col-md-5">
                                            <input type="date" name="dob" class="form-control" placeholder="Date of Birth" style="border-radius: 2px; height: 40px; border-color: #e0e0e0; font-size: 14px;" value="<?php echo htmlspecialchars($dob); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <div class="custom-control custom-radio custom-control-inline">
                                            ...
                                            <label class="custom-control-label" for="genderMale" style="font-size: 14px; font-weight: 400; cursor: pointer;">Male</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline ml-4">
                                            <input type="radio" id="genderFemale" name="gender" class="custom-control-input" value="female">
                                            <label class="custom-control-label" for="genderFemale" style="font-size: 14px; font-weight: 400; cursor: pointer;">Female</label>
                                        </div>
                                    </div>
                                </div>

                                <div class="section mb-5">
                                    <h4 style="font-size: 18px; font-weight: 500; margin-bottom: 24px;">Email Address <!-- <a href="profile_edit.php" style="font-size: 14px; font-weight: 500; color: #2874f0; float: right; text-decoration: none;">Edit</a> --></h4>
                                    <div class="row">
                                        <div class="col-md-5">
                                            <input type="email" name="email" class="form-control" placeholder="Email Address" value="<?php echo htmlspecialchars($email); ?>" style="border-radius: 2px; height: 40px; border-color: #e0e0e0; font-size: 14px; background-color: #fafafa;" readonly>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <h4 style="font-size: 18px; font-weight: 500; margin-bottom: 24px;">Mobile Number <!-- <a href="#" style="font-size: 14px; font-weight: 500; color: #2874f0; float: right; text-decoration: none;">Edit</a> --></h4>
                                    <div class="row">
                                        <div class="col-md-5">
                                            <input type="number" name="number" class="form-control" placeholder="Mobile Number" value="<?php echo htmlspecialchars($number); ?>" style="border-radius: 2px; height: 40px; border-color: #e0e0e0; font-size: 14px;">
                                        </div>
                                    </div>
                                </div>
                                
                                <button type="submit" name="save" class="btn btn-primary" style="background-color: #2874f0; border: none; border-radius: 2px; padding: 10px 40px; font-size: 16px; font-weight: 500; box-shadow: 0 1px 2px 0 rgba(0,0,0,.2);">SAVE</button>
                            </form>
