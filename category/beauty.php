        ...
        <div class="content-wrapper" style="background-color: transparent;">
            <div class="hero">
                <div class="categories-container"
                    ...
                    <div class="category-item">
                        <i class="fa-solid fa-gem" style="color: #2874f0;"></i>
                        <span style="color:#2874f0 !important; font-weight: bold;"><a href="beauty.php">Beauty</a></span>
                        <div
            ...
            <div class="content">
                ...
                <?php
                    ...
                    $query = "SELECT * FROM products
                              WHERE LOWER(TRIM(category)) IN ('beauty', 'beautys')";
                    ...
                    ?>
                     ...
                     <div class="product-wrapper"
                        ...
                        <div class="section-header"
                            ...
                            <h2 style="margin: 0; font-size: 22px; font-weight: 500;">Best Beauty Products</h2>
                        ...
                        <div class="row m-0 p-3" style="display: flex; flex-wrap: wrap;">
                            <?php if (!empty($beautys)): ?>
                                <?php foreach ($beautys as $beauty): ?>
                            ...
                            <?php else: ?>
                                <div class="col-12">
                                    <p style="margin: 0; padding: 24px; text-align: center; color: #666;">
                                        No beautys products found right now.
                                    </p>
                                </div>
                            <?php endif; ?>
                        </div>
