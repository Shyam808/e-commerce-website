        ...
        <div class="content-wrapper" style="background-color: transparent;">
            <div class="hero">
                <div class="categories-container"
                    ...
                    <div class="category-item">
                        <i class="fa-solid fa-baseball-bat-ball" style="color: #2874f0;"></i>
                        <span  style="color:#2874f0 !important; font-weight: bold;"><a href="sports.php">Sports</a></span>
                        <div
            ...
            <div class="content">
                ...
                <?php
                    ...
                    $query = "SELECT * FROM products
                              WHERE LOWER(TRIM(category)) IN ('sport', 'sports', 'sports')";
                    ...
                    ?>
                     ...
                     <div class="product-wrapper"
                        ...
                        <div class="section-header"
                            ...
                            <h2 style="margin: 0; font-size: 22px; font-weight: 500;">Best Sports</h2>
                                        ...
                                        <div class="card product-card"
                                            ...
                                            <div class="card-body text-center" style="padding: 10px;">
                                                <div class="card-head"
                                                    ...
                                                    <a href="../products.php?id=<?php echo $sport['id']; ?>"
                            ...
                            <?php else: ?>
                                <div class="col-12">
                                    <p style="margin: 0; padding: 24px; text-align: center; color: #666;">
                                        No Sports products found right now.
                                    </p>
                                </div>
                            <?php endif; ?>
                        </div>
