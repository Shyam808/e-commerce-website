        ...
        <div class="content-wrapper" style="background-color: transparent;">
            <div class="hero">
                <div class="categories-container"
                    ...
                    <div class="category-item">
                        <i class="fa-solid fa-helmet-un" style="color: #2874f0;"></i>
                        <span style="color:#2874f0 !important; font-weight: bold;">Auto Accessories</span>
                        <div
            ...
            <div class="content">
                ...
                <?php
                    ...
                    $query = "SELECT * FROM products
                              WHERE LOWER(TRIM(category)) IN ('auto', 'autos', 'Auto Accessories')";
                    ...
                    ?>
                     ...
                     <div class="product-wrapper"
                        ...
                        <div class="section-header"
                            ...
                            <h2 style="margin: 0; font-size: 22px; font-weight: 500;">Best auto & Accessories</h2>
                                        ...
                                        <div class="card product-card"
                                            ...
                                            <div class="card-body text-center" style="padding: 10px;">
                                                ...
                                                <div class="text-muted"
                                                    ...
                                                    <?php echo htmlspecialchars($auto['desc']); ?>
                                                </div>
                                                <form method="POST" class="text-center mt-auto d-inline-block w-100">
                                                    <input type="hidden" name="product_id" value="<?php echo $auto['id']; ?>">
                                                    <input type="hidden" name="product_name"
                                                        value="<?php echo htmlspecialchars($auto['name']); ?>">
                                                    <input type="hidden" name="product_image"
                                                        value="<?php echo $auto['img']; ?>">
                            ...
                            <?php else: ?>
                                <div class="col-12">
                                    <p style="margin: 0; padding: 24px; text-align: center; color: #666;">
                                        No auto Accessories products found right now.
                                    </p>
                                </div>
                            <?php endif; ?>
                        </div>
