        ...
        <div class="content-wrapper" style="background-color: transparent;">
            <div class="hero">
                <div class="categories-container"
                    ...
                    <div class="category-item">
                        <i class="fa-solid fa-mobile-screen-button" style="color: #2874f0;"></i>
                        <span style="font-size: 13px;"><a href="mobiles.php"
                                style="color:#2874f0 !important; font-weight: bold;">Mobiles</a></span>
                        <div
            ...
            <div class="content">
                <div class="container" style="max-width: 1800px;">
                    <div id="autoScrollContainer" class="featured-banners"
                        ...
                        <div class="featured-banner" style="width: 585px; height: 300px;"><a
                                href="../products.php?id=40">
                                <img src="https://rukminim1.flixcart.com/fk-p-flap/1580/770/image/36e488546c97ab15.jpg?q=80"
                                    alt="Banner 2" style="border-radius: 4px; cursor: pointer; height: 300px;">
                            </a>
                        </div>
                        <div class="featured-banner" style="width: 585px; height: 300px;"><a
                                href="../products.php?id=41">
                                <img src="https://rukminim1.flixcart.com/fk-p-flap/1580/770/image/184bc5fded583b58.jpg?q=80"
                                    alt="Banner 2" style="border-radius: 4px; cursor: pointer; height: 300px;">
                            </a>
                        </div>
                        <div class="featured-banner" style="width: 585px; height: 300px;"><a
                                href="../products.php?id=42">
                                <img src="https://rukminim1.flixcart.com/fk-p-flap/1580/770/image/0731e50ff81b23ed.jpg?q=80"
                                    alt="Banner 2" style="border-radius: 4px; cursor: pointer; height: 300px;">
                            </a>
                        </div>
                        <div class="featured-banner" style="width: 585px; height: 300px;"><a
                                href="../products.php?id=43">
                                <img src="https://rukminim1.flixcart.com/fk-p-flap/1580/770/image/3b0f6e8f5b909fd9.jpg?q=80"
                                    alt="Banner 2" style="border-radius: 4px; cursor: pointer; height: 300px;">
                            </a>
                        </div>
                        <div class="featured-banner" style="width: 585px; height: 300px;"><a
                                href="../products.php?id=44">
                                <img src="https://rukminim1.flixcart.com/fk-p-flap/1580/770/image/373c4f61d862cf42.png?q=80"
                                    alt="Banner 2" style="border-radius: 4px; cursor: pointer; height: 300px;">
                            </a>
                        </div>
                        <div class="featured-banner" style="width: 585px; height: 300px;"><a
                                href="../products.php?id=45">
                                <img src="https://rukminim1.flixcart.com/fk-p-flap/1580/770/image/081ce0307ed48951.jpg?q=80"
                                    alt="Banner 2" style="border-radius: 4px; cursor: pointer; height: 300px;">
                            </a>
                        </div>
                        <div class="featured-banner" style="width: 585px; height: 300px;"><a
                                href="../products.php?id=46">
                                <img src="https://rukminim1.flixcart.com/fk-p-flap/1580/770/image/fe7c99d717aea9a6.png?q=80"
                                    alt="Banner 2" style="border-radius: 4px; cursor: pointer; height: 300px;">
                            </a>
                        </div>
                        <div class="featured-banner" style="width: 585px; height: 300px;"><a
                                href="../products.php?id=47">
                                <img src="https://rukminim1.flixcart.com/fk-p-flap/1580/770/image/2858eec69ccd127d.png?q=80"
                                    alt="Banner 2" style="border-radius: 4px; cursor: pointer; height: 300px;">
                            </a>
                        </div>
                    </div>
                    ...
                    foreach ($products as $catalogProduct) {
                        ...
                        if (($catalogId >= 15 && $catalogId <= 49) || $catalogId === 666) {
                            $mobiles[] = [
                                'id' => $catalogId,
                    ...
                    <div class="product-wrapper"
                        ...
                        <div class="section-header"
                            ...
                            <h2 style="margin: 0; font-size: 22px; font-weight: 500;">Best Mobile Phones</h2>
