        ...
        <div class="content-wrapper" style="background-color: transparent;">
            <div class="hero">
                <div class="categories-container"
                    ...
                    <div class="category-item">
                        <i class="fa-regular fa-lightbulb" style="color: #2874f0;"></i>
                        <span style="font-size: 13px;"><a href="home.php" style="color:#2874f0 !important; font-weight: bold;">Home</a></span>
                        <div
