...
function getCheckoutProductPrice($conn, $product_id, $fallback_prices)
{
    ...
    $query = "SELECT price FROM products WHERE source_product_id = $product_id OR id = $product_id LIMIT 1";
    $result = mysqli_query($conn, $query);

    if (!$result) {
        $result = mysqli_query($conn, "SELECT price FROM products WHERE id = $product_id LIMIT 1");
    }
